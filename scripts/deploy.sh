...
TESTING_ARTIFACTS_BUCKET=food-lambda-test
TESTING_CLOUDFORMATION_EXECUTION_ROLE="arn:aws:iam::$AWS_ACCOUNT_ID:role/food-cloudformation-test"
TESTING_STACK_NAME=food-api-test
